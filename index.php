...
if(isset($_POST['submit'])){
    ...
    $url = file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=".urlencode($secret) ."&response=". urlencode($response)."&remoteip=".$remoteip);
...
<?php
    ...
    // Orientação e Coorientação
        ...
        if (!empty($fichaNomeCoorientador) && $fichaTitulacaoCoorientador == "coorientadorespecialista" && isset($fichaCoorientadora)) {
            $fichaNotas .= "<br>" . $espaço . $espaço . $espaço . $espaço . $espaço . $espaço . "Coorientador(a): Profª. Esp." . " " . $fichaNomeCoorientador;
        } else if (!empty($fichaNomeCoorientador) && $fichaTitulacaoCoorientador == "coorientadorespecialista") {
            $fichaNotas .= "<br>" . $espaço . $espaço . $espaço . $espaço . $espaço . $espaço . "Coorientação: Prof. Esp." . " " . $fichaNomeCoorientador;
        } else if (!empty($fichaNomeCoorientador) && $fichaTitulacaoCoorientador == "coorientadormestre" && isset($fichaCoorientadora)) {
            $fichaNotas .= "<br>" . $espaço . $espaço . $espaço . $espaço . $espaço . $espaço . "Coorientador(a): Profª. MSc." . " " . $fichaNomeCoorientador;
        } else if (!empty($fichaNomeCoorientador) && $fichaTitulacaoCoorientador == "coorientadormestre") {
            $fichaNotas .= "<br>" . $espaço . $espaço . $espaço . $espaço . $espaço . $espaço . "Coorientador(a): Prof. Me." . " " . $fichaNomeCoorientador;
        } else if (!empty($fichaNomeCoorientador) && $fichaTitulacaoCoorientador == "coorientadordoutor" && isset($fichaCoorientadora)) {
            $fichaNotas .= "<br>" . $espaço . $espaço . $espaço . $espaço . $espaço . $espaço . "Coorientação: Profª. Dra." . " " . $fichaNomeCoorientador;
        } else if (!empty($fichaNomeCoorientador) && $fichaTitulacaoCoorientador == "coorientadordoutor") {
            $fichaNotas .= "<br>" . $espaço . $espaço . $espaço . $espaço . $espaço . $espaço . "Coorientador(a): Prof. Dr." . " " . $fichaNomeCoorientador;
        } else if (!empty($fichaNomeCoorientador) && $fichaTitulacaoCoorientador == "coorientadorgraduado" && isset($fichaCoorientadora)) {
            $fichaNotas .= "<br>" . $espaço . $espaço . $espaço . $espaço . $espaço . $espaço . "Coorientador(a): Profª." . " " . $fichaNomeCoorientador;
        } else if (!empty($fichaNomeCoorientador) && $fichaTitulacaoCoorientador == "coorientadorgraduado") {
            $fichaNotas .= "<br>" . $espaço . $espaço . $espaço . $espaço . $espaço . $espaço . "Coorientador(a): Prof." . " " . $fichaNomeCoorientador;
        } else {
            $fichaNotas .= "";
        }

        $fichaNotas .= "<br>".$espaço.$espaço.$espaço.$espaço.$espaço.$espaço;

        if ($fichaUnidade == "CABAE" && $fichaTipoTrabalho == "Tese") {
            $fichaNotas .= "Tese (Doutorado) - " . "Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica.", " . $fichaCurso1 . "," . " Abaetetuba, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CALTA" && $fichaTipoTrabalho == "Tese") {
            $fichaNotas .= "Tese (Doutorado) - " . "Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica.", " . $fichaCurso1 . "," . " Altamira, " . $fichaAno . ".\n"; 
        } elseif ($fichaUnidade == "CANAN" && $fichaTipoTrabalho == "Tese") {
            $fichaNotas .= "Tese (Doutorado) - " . "Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica.", " . $fichaCurso1 . "," . " Ananindeua, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CBRAG" && $fichaTipoTrabalho == "Tese") {
            $fichaNotas .= "Tese (Doutorado) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica.", " . $fichaCurso1 . "," . " Bragança, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CBREV" && $fichaTipoTrabalho == "Tese") {
            $fichaNotas .= "Tese (Doutorado) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica.", " . $fichaCurso1 . "," . " Breves, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CUNTI" && $fichaTipoTrabalho == "Tese") {
            $fichaNotas .= "Tese (Doutorado) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica.", " . $fichaCurso1 . "," . " Cametá, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CUNCA" && $fichaTipoTrabalho == "Tese") {
            $fichaNotas .= "Tese (Doutorado) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica.", " . $fichaCurso1 . "," . " Capanema, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CCAST" && $fichaTipoTrabalho == "Tese") {
            $fichaNotas .= "Tese (Doutorado) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica.", " . $fichaCurso1 . "," . " Castanhal, " . $fichaAno . ".\n";  
        } elseif ($fichaUnidade == "CUSAL" && $fichaTipoTrabalho == "Tese") {
            $fichaNotas .= "Tese (Doutorado) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica.", " . $fichaCurso1 . "," . " Salinópolis, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CSOUR" && $fichaTipoTrabalho == "Tese") {
            $fichaNotas .= "Tese (Doutorado) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica.", " . $fichaCurso1 . "," . " Soure, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CAMTU" && $fichaTipoTrabalho == "Tese" || $fichaUnidade == "NDAE" && $fichaTipoTrabalho == "Tese") {
            $fichaNotas .= "Tese (Doutorado) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica.", " . $fichaCurso1 . "," . " Tucuruí, " . $fichaAno . ".\n";
        } elseif ($fichaTipoTrabalho == "Tese")
    //$texto .= "Tese (Doutorado) - Universidade Federal do Pará, ".$curso1.", Belém, " .$ano.".\n";
        {
            $fichaNotas .= "Tese (Doutorado) - " . "Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica . ", " . $fichaCurso1 . "," . " Belém, " . $fichaAno . ".\n";
        }
    ...
    // =_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=
        elseif ($fichaUnidade == "CABAE" && $fichaTipoTrabalho == "Dissertação") {
            $fichaNotas .= "Dissertação (Mestrado) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica.", ".$fichaCurso2 . "," . " Abaetetuba, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CALTA" && $fichaTipoTrabalho == "Dissertação") {
            $fichaNotas .= "Dissertação (Mestrado) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica.", ".$fichaCurso2 . "," . " Altamira, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CANAN" && $fichaTipoTrabalho == "Dissertação") {
            $fichaNotas .= "Dissertação (Mestrado) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica.", ".$fichaCurso2 . "," . " Ananindeua, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CBRAG" && $fichaTipoTrabalho == "Dissertação") {
            $fichaNotas .= "Dissertação (Mestrado) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica.", ".$fichaCurso2 . "," . " Bragança, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CBREV" && $fichaTipoTrabalho == "Dissertação") {
            $fichaNotas .= "Dissertação (Mestrado) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica.", ".$fichaCurso2 . "," . " Breves, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CUNTI" && $fichaTipoTrabalho == "Dissertação") {
            $fichaNotas .= "Dissertação (Mestrado) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica.", ".$fichaCurso2 . "," . " Cametá, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CUNCA" && $fichaTipoTrabalho == "Dissertação") {
            $fichaNotas .= "Dissertação (Mestrado) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica.", ".$fichaCurso2 . "," . " Capanema, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CCAST" && $fichaTipoTrabalho == "Dissertação") {
            $fichaNotas .= "Dissertação (Mestrado) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica.", ".$fichaCurso2 . "," . " Castanhal, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CUSAL" && $fichaTipoTrabalho == "Dissertação") {
            $fichaNotas .= "Dissertação (Mestrado) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica.", ".$fichaCurso2 . "," ." Salinópolis, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CSOUR" && $fichaTipoTrabalho == "Dissertação") {
            $fichaNotas .= "Dissertação (Mestrado) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica.", ".$fichaCurso2 . "," ." Soure, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CAMTU" && $fichaTipoTrabalho == "Dissertação" || $fichaUnidade == "NDAE" && $fichaTipoTrabalho == "Dissertação") {
            $fichaNotas .= "Dissertação (Mestrado) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica.", ".$fichaCurso2 . "," . " Tucuruí, " . $fichaAno . ".\n";
        } elseif ($fichaTipoTrabalho == "Dissertação")
        {
            $fichaNotas .= "Dissertação (Mestrado) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica . ", " . $fichaCurso2 . "," . " Belém, " . $fichaAno . ".\n";
        }
    ...
    // =_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=
        elseif ($fichaUnidade == "CABAE" && $fichaTipoTrabalho == "TCC Especialização") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Especialização) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica . ", " . $fichaCurso3 . "," . " Abaetetuba, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CALTA" && $fichaTipoTrabalho == "TCC Especialização") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Especialização) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica . ", " . $fichaCurso3 . "," . " Altamira, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CANAN" && $fichaTipoTrabalho == "TCC Especialização") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Especialização) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica . ", " . $fichaCurso3 . "," . " Ananindeua, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CBRAG" && $fichaTipoTrabalho == "TCC Especialização") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Especialização) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica . ", " . $fichaCurso3 . "," . " Bragança, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CBREV" && $fichaTipoTrabalho == "TCC Especialização") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Especialização) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica . ", " . $fichaCurso3 . "," . " Breves, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CUNTI" && $fichaTipoTrabalho == "TCC Especialização") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Especialização) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica . ", " . $fichaCurso3 . "," . " Cametá, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CUNCA" && $fichaTipoTrabalho == "TCC Especialização") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Especialização) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica . ", " . $fichaCurso3 . "," . " Capanema, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CCAST" && $fichaTipoTrabalho == "TCC Especialização") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Especialização) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica . ", " . $fichaCurso3 . "," . " Castanhal, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CUSAL" && $fichaTipoTrabalho == "TCC Especialização") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Especialização) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica . ", " . $fichaCurso3 . "," . " Salinópolis, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CSOUR" && $fichaTipoTrabalho == "TCC Especialização") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Especialização) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica . ", " . $fichaCurso3 . "," . " Soure, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CAMTU" && $fichaTipoTrabalho == "TCC Especialização" || $fichaUnidade == "NDAE" && $fichaTipoTrabalho == "TCC Especialização") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Especialização) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica . ", " . $fichaCurso3 . "," . " Tucuruí, " . $fichaAno . ".\n";
        } elseif ($fichaTipoTrabalho == "TCC Especialização") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Especialização) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica . ", " . $fichaCurso3 . "," . " Belém, " . $fichaAno . ".\n";
        }
    ...
    // =_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=
        elseif ($fichaUnidade == "CABAE" && $fichaTipoTrabalho == "TCC Graduação") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Graduação) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica . ", " . $fichaCurso4 . "," . " Abaetetuba, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CALTA" && $fichaTipoTrabalho == "TCC Graduação") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Graduação) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica. ", " . $fichaCurso4 . "," . " Altamira, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CANAN" && $fichaTipoTrabalho == "TCC Graduação") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Graduação) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica. ", " . $fichaCurso4 . "," . " Ananindeua, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CBRAG" && $fichaTipoTrabalho == "TCC Graduação") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Graduação) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica. ", " . $fichaCurso4 . "," . " Bragança, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CBREV" && $fichaTipoTrabalho == "TCC Graduação") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Graduação) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica. ", " . $fichaCurso4 . "," . " Breves, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CUNTI" && $fichaTipoTrabalho == "TCC Graduação") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Graduação) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica. ", " . $fichaCurso4 . "," . " Cametá, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CUNCA" && $fichaTipoTrabalho == "TCC Graduação") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Graduação) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica. ", " . $fichaCurso4 . "," . " Capanema, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CCAST" && $fichaTipoTrabalho == "TCC Graduação") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Graduação) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica. ", " . $fichaCurso4 . "," . " Castanhal, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CUSAL" && $fichaTipoTrabalho == "TCC Graduação") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Graduação) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica. ", " . $fichaCurso4 . "," . " Salinópolis, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CSOUR" && $fichaTipoTrabalho == "TCC Graduação") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Graduação) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica. ", " . $fichaCurso4 . "," . " Soure, " . $fichaAno . ".\n";
        } elseif ($fichaUnidade == "CAMTU" && $fichaTipoTrabalho == "TCC Graduação" || $fichaUnidade == "NDAE" && $fichaTipoTrabalho == "TCC Graduação") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Graduação) - "."Universidade Federal do Pará, ".$fichaNomeUnidadeAcademica. ", " . $fichaCurso4 . "," . " Tucuruí, " . $fichaAno . ".\n";
        } elseif ($fichaTipoTrabalho == "TCC Graduação") {
            $fichaNotas .= "Trabalho de Conclusão de Curso (Graduação) - "."Universidade Federal do Pará, ". $fichaNomeUnidadeAcademica . ", " . $fichaCurso4 . "," . " Belém, " . $fichaAno . ".\n";
        }
    ...
    // Adiciona uma pagina
        ...
        .$espaço.$espaço.$espaço.$espaço.$espaço.$espaço.$fichaDescricaoFisica.'</td>
        ...
        <td style="width:280px"><br>'.$espaço.$espaço.$espaço.$espaço.$espaço.$espaço.$fichaNotas.'</td>
        <td style="width:147px"> </td>
        </tr>
        <!-- Notas -->
        ...
        <tr>
        <td style="width:160px"> </td>
        <td style="width:260px">' .$espaço.$espaço.$espaço.$espaço.$espaço.$espaço.$fichaPalavrasChave . '</td>
        <td style="width:147px"> </td>
        </tr>
        <!-- Keywords -->
